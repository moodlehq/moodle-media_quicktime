 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class media_quicktime_testcase extends advanced_testcase {
    ...
    public function test_is_installed() {
        ...
        $this->assertEquals(['quicktime' => 'quicktime'], $sortorder);
    }
    ...
    public function test_embed_url() {
        ...
        $url = new moodle_url('http://example.org/1.mpg');
